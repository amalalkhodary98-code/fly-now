...
if (!isset($_SESSION['role'])) {
    die(isset($_SESSION['lang']) && $_SESSION['lang'] == 'en' ? "🚫 Login required" : "🚫 يجب تسجيل الدخول");
}
        ...
        <div class="gaza-card">
            ...
            <div class="action-buttons">
                ...
                <a href="delete_gaza_request.php?id=<?= $row['id'] ?>" class="delete-btn"
                   onclick="return confirm('<?= $langcod == 'ar' ? 'هل أنت متأكد من الحذف؟' : 'Are you sure you want to delete?' ?>')">
